    ...
    return (
        <div id="footer" className="flex flex-row gap-4 p-4 bottom-0 left-0 right-0">
            <div id="footer-l" className="basis-1/3 p-5 transition-colors group border border-transparent rounded-lg hover:border-pink-300 hover:dark:bg-neutral-800/10 hover:text-pink-300">
                ...
                <pre>pingpox.com</pre>
                <br />
                <p className="font-thin text-xs">Adalah platform olahraga tenis meja berbasis teknologi dan beroperasi 24/7, mulai dari penyewaan meja, janjian dengan pelatih dan juga berlangganan kelas latihan dan penyelenggaraan pertandigan/turnamen terotomasi</p>
            </div>
            <div id="footer-c" className="basis-1/3 p-5 transition-colors border border-transparent rounded-lg hover:border-pink-300 hover:dark:bg-neutral-800/10 hover:text-pink-300">
                <div className="flex flex-col space-y-2">
                    ...
                    <Link href="/tournaments">
                        <span className="hover:text-pink-500">Penyelenggaraan Turnamen</span>
                    </Link>
                    ...
                    <Link target="_blank" href="https://github.com/users/burubur/projects/6">
                        <span className="hover:text-pink-500">Project Pingpox</span>
                    </Link>
                </div>
            </div>
            <div id="footer-l" className="group basis-1/3 p-5 transition-colors border border-transparent rounded-lg hover:border-pink-300 hover:dark:bg-neutral-800/10 hover:text-pink-300">
                <div className="flex flex-col space-y-2">
                    <span className="mb-4 font-semibold">
                        Media Sosial Kami
                    </span>
